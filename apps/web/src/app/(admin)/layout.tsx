export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen">
      {/* Admin Sidebar */}
      <aside className="hidden w-72 border-r border-border bg-foreground lg:block">
        <div className="flex h-16 items-center border-b border-white/10 px-6">
          <span className="text-lg font-bold text-white">Daymenify Admin</span>
        </div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-border bg-card px-6">
          ...
          <div className="flex items-center gap-3">
            <span className="hidden text-sm font-medium text-foreground md:inline">Administrator</span>
